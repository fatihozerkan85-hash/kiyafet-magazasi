...
const urunler = [
  ...
  },
  {
    id: '3',
    ad: 'Şık Bluz',
    aciklama: 'Ofis için ideal şık bluz',
    fiyat: 149.99,
    eskiFiyat: 199.99,
    kategori: 'bluz',
    beden: ['S', 'M', 'L'],
  ...
  },
  {
    id: '4',
    ad: 'Mini Etek',
    aciklama: 'Günlük kullanım için rahat etek',
    fiyat: 179.99,
    kategori: 'etek',
    beden: ['S', 'M', 'L', 'XL'],
    renk: ['Siyah', 'Lacivert', 'Kahverengi'],
    resimler: ['https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=400&h=600&fit=crop'],
    stokDurumu: true,
    marka: 'Casual Wear'
  }
];
